# Домашнее задание №2 к лекции «Работа с DOM»

[![Build status](https://ci.appveyor.com/api/projects/status/o9t76q7bhms3bfjq?svg=true)](https://ci.appveyor.com/project/yuriyvyatkin/ahj-hw-2-2-sorting-with-data-attributes)
